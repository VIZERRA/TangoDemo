...
Properties 
{
    ...
    _ColorMultyplier ("color multyplier", Float) = 1.0
}
SubShader 
{
    ...
    Pass 
    {
		...
		uniform float _ColorMultyplier;
        ...
        void main()
        {
            ...
            //gl_FragColor = vec4(r * _ColorMultyplier, g * _ColorMultyplier, b * _ColorMultyplier, 1.0);
            gl_FragColor = vec4(r * _ColorMultyplier, g * _ColorMultyplier , b * _ColorMultyplier, 1.0);
        }
        #endif
